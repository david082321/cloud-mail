const en = {
	...
	oauthAlreadyBound: 'The user already has a bound email address',
	oauthGrantInvalid: 'OAuth binding verification is invalid or expired',
	...
	resendStatusUpdateFailed: 'Failed to update the email status record',
