const en = {
    ...
    pwdLengthMsg: 'Password must be at least 12 characters',
    ...
    restoreEmailsConfirm: 'Restore the selected emails?',
    restoreOneEmailConfirm: 'Restore this email?',
    permanentDeleteEmailsConfirm: 'Permanently delete the selected emails? This action cannot be undone.',
    permanentDeleteOneEmailConfirm: 'Permanently delete this email? This action cannot be undone.',
    restoreSuccessMsg: 'Restored successfully',
    permanentDeleteSuccessMsg: 'Permanently deleted',
    ...
    oauthStateInvalid: 'OAuth verification expired or did not match. Please try again.',
