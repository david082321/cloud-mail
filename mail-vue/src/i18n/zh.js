const zh = {
    ...
    restoreEmailsConfirm: '确认还原选中的邮件吗？',
    restoreOneEmailConfirm: '确认还原这封邮件吗？',
    permanentDeleteEmailsConfirm: '确认永久删除选中的邮件吗？此操作无法撤销。',
    permanentDeleteOneEmailConfirm: '确认永久删除这封邮件吗？此操作无法撤销。',
    restoreSuccessMsg: '还原成功',
    permanentDeleteSuccessMsg: '永久删除成功',
    sending: '邮件正在发送中',
    ...
    oauthStateInvalid: 'OAuth 验证已过期或不匹配，请重新尝试',
    linuxDoUsername: '用户名',
